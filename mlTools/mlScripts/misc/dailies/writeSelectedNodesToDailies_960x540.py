...
def main():
    ...
    for n in nSel:
        ...
        if 'file' in n.knobs():
            ...
            cmd= [ffmpegLocation +' -f image2 -start_number '+startFrame+' -r '+frmRate+' -i '+path+' -c:v libx264 -g 1 -tune stillimage -crf 18 -bf 0 -r '+frmRate+' -force_fps -pix_fmt yuv420p -s 960x540 '+output]
